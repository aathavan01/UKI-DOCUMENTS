...
document.write("charAt : " + text1.charAt(2) + "<br>");
...
document.write("slice : " + text3.slice(7) + "<br>");
document.write("substr : " + text3.substr(1,5) + "<br>");
...
document.write("ceil : " + Math.ceil(4.2) + "<br>");
document.write("floor : " + Math.floor(4.6) + "<br>");
